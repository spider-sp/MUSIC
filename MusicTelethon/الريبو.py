...
{HNDLR}تشغيل فيديو + اسم الاغنيه او لينك
مثل 🤬
{HNDLR}تشغيل فيديو البخت
لتوقيف الاغنيه خالص ⏹ 
{HNDLR}انهاء
لتحميل الاغاني ⏬
...
{HNDLR}تحميل البخت
لتحميل الفديوهات ⏬
`{HNDLR}تحميل فيديو + اسم الاغنيه او اللينك
مثل 😴
{HNDLR}تحميل فيديو البخت
لتشغيل الاغنيه التاليه 😺
`{HNDLR}التالي`
علشان تاخد دور في تشغيل الاغاني 😴
`بعده` + اسم الاغنيه 
مثل 
بعده البخت
لو السورس هنج 😤
